...
CREATE OR REPLACE FUNCTION public.get_public_venues(venue_limit integer DEFAULT 50, search_query text DEFAULT NULL, venue_tags text[] DEFAULT NULL, min_capacity integer DEFAULT NULL)
 RETURNS TABLE(
   id uuid, 
   name text, 
   description text, 
