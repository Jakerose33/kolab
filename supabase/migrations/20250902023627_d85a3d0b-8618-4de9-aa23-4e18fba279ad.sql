...
-- Only basic info (name, handle, avatar) is accessible without authentication
-- Additional fields require privacy settings or ownership
...
-- Update existing privacy settings to include bio setting (set to private by default)
...
-- Create a view for public profile access that respects privacy settings
...
-- Update the existing privacy-aware function to be more restrictive by default
